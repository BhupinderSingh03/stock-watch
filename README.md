...
15. Apache Camel is used for Kafka integration in the regulatory-authority service and log-writer service.
16. jmeter script is exported from the jmeter tool where i am running 100 threads to process 100 requests in 1 second. File is present at the root of the project with name `trades_load_test.jmx`. You can run it using the jmeter tool to test the performance of the trade-monitor service.
